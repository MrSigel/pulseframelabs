          ...
          <CardContent>
            <Tabs defaultValue="small">
              ...
              <TabsContent value="small" className="mt-4 space-y-4">
                <OverlayLink url={`${overlayBaseUrl}/overlay/balance_small?uid=${uid || ""}`} obsSize="320 × 120" />
              ...
              <TabsContent value="normal" className="mt-4 space-y-4">
                <OverlayLink url={`${overlayBaseUrl}/overlay/balance_normal?uid=${uid || ""}`} obsSize="280 × 200" />
              ...
              <TabsContent value="large" className="mt-4 space-y-4">
                <OverlayLink url={`${overlayBaseUrl}/overlay/balance_large?uid=${uid || ""}`} obsSize="460 × 150" />
