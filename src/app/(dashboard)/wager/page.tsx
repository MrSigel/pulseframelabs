          ...
          <CardContent className="pt-6">
            <Tabs defaultValue="small">
              ...
              <TabsContent value="small" className="mt-4 space-y-4">
                <OverlayLink url={`${overlayBaseUrl}/overlay/wager_bar_small?uid=${uid || ""}`} obsSize="500 × 200" />
              ...
              <TabsContent value="normal" className="mt-4 space-y-4">
                <OverlayLink url={`${overlayBaseUrl}/overlay/wager_bar_normal?uid=${uid || ""}`} obsSize="540 × 300" />
