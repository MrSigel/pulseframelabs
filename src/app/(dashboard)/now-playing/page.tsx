            ...
            <div className="px-6 pt-3 flex gap-4 border-b border-white/[0.06] shrink-0">
              {[
                ...
                <button
                  ...
                  className={`pb-3 text-sm font-medium transition-colors relative ${
                    casinoTab === tab.key ? "text-blue-400" : "text-slate-500 hover:text-slate-300"
                  }`}
                >
                  {tab.label}
                  {casinoTab === tab.key && (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 px-3 py-2.5">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              ...
                              >
                                <Pencil className={`h-3.5 w-3.5 transition-colors ${isEditing ? "text-blue-400" : "text-slate-400"}`} />
                              </button>
                            </div>
                          </div>
