  ...
  return (
    <section id="pricing" className="section" style={{ padding: 'clamp(100px, 14vw, 180px) 0' }}>
      <div className="container">
        ...
        <div ref={cardsRef} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: 'clamp(16px, 2vw, 24px)', maxWidth: '1000px', margin: '0 auto', perspective: '1000px' }}>
          {plans.map(plan => (
            <GlassCard key={plan.name} className="pricing-card" style={{
              ...
              <div style={{ marginBottom: '28px' }}>
                ...
                <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(2rem, 4vw, 2.8rem)', fontWeight: 700, color: plan.popular ? 'var(--gold)' : 'var(--text-primary)', lineHeight: 1, marginBottom: '8px' }}>{plan.price}</div>
